...
$listaConsultorio = $objCon->listarConsultorios('', '1');
$listaConsultorio = $listaConsultorio->fetchAll(PDO::FETCH_NAMED);

$listaCliente = $objCli->listarCliente('', '1');
...
<div class="row">
  ...
  <h3 class="text-center" id="title">Citas Consultorios</h3>
  </div>
</div>
</div>
